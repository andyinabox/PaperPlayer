...
class testApp : public ofBaseApp{
	...
	public:
        ...
        /* Video to distort onto the marker */
        ofVideoPlayer displayVideo;
//        ofImage displayVideoImage;
        float displayVideoWidth;
        float displayVideoHeight;
    
        /* The four corners of the image */
		vector<ofPoint> displayImageCorners;
        vector<ofPoint> displayVideoCorners;
